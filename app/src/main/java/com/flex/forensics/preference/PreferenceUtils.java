...
package com.flex.forensics.preference;
...
import com.flex.forensics.CameraSource;
import com.flex.forensics.CameraSource.SizePair;
...
//  }
  ...
  @Nullable
  public static void setResult(Context context,String result){
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
